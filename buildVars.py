...
addon_info = AddonInfo(
	...
	addon_name="WinTeleport",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("WinTeleport"),
	# Add-on description
...
- Exclude pyvda development and test files from add-on bundles."""),
	...
	addon_url="https://github.com/cary-rowen/WinTeleport",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/cary-rowen/WinTeleport",
...
pythonSources: list[str] = ["addon/globalPlugins/WinTeleport/*.py"]
...
excludedFiles: list[str] = [
	...
	"pyvdaRepo/.git",
	"pyvdaRepo/.gitignore",
	"pyvdaRepo/.readthedocs.yml",
	"pyvdaRepo/create_tag.sh",
	"pyvdaRepo/docs/**",
	"pyvdaRepo/Makefile",
	"pyvdaRepo/README.md",
	"pyvdaRepo/requirements.txt",
	"pyvdaRepo/setup.py",
	"pyvdaRepo/tests/**",
]
